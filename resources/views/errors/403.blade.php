...
<body class="min-h-screen bg-slate-50 dark:bg-slate-950 font-ui text-slate-900 dark:text-white overflow-hidden">
    ...
    <div class="fixed inset-0 -z-10 pointer-events-none">
        <div class="absolute top-[-150px] left-1/2 h-[500px] w-[500px] -translate-x-1/2 rounded-full bg-red-600/10 dark:bg-red-600/10 blur-3xl"></div>
        <div class="absolute bottom-[-100px] right-[-100px] h-[400px] w-[400px] rounded-full bg-rose-500/10 dark:bg-rose-500/10 blur-3xl"></div>
    ...
    <div class="flex min-h-screen flex-col items-center justify-center px-4 text-center">
        ...
        {{-- Forbidden badge --}}
        <div class="mb-5 inline-flex items-center gap-2 rounded-full border border-red-500/20
                    bg-red-500/10 px-4 py-1.5 text-xs font-semibold text-red-600 dark:text-red-400">
        ...
        <div class="flex flex-col sm:flex-row items-center gap-3">
            <a href="{{ url('/') }}"
               class="inline-flex items-center gap-2 rounded-xl bg-red-500 hover:bg-red-400
