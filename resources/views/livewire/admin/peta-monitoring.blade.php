<section class="p-4 sm:p-6">
    <div class="mx-auto space-y-5">
        ...
        <div
            class="rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950/60 overflow-hidden p-4">
            <div class="relative" x-data="windyMapComponent({
                key: '{{ $windyKey }}',
                devices: @js($devices),
                overlay: 'wind',
                lat: -6.2,
