<section class="p-3 sm:p-4 md:p-6">
    <div class="mx-auto max-w-7xl space-y-5">
        ...
        <div class="rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 overflow-hidden shadow-sm">
            ...
            {{-- Toolbar --}}
            <div class="flex flex-col gap-3 px-4 py-3 bg-zinc-50/80 dark:bg-zinc-900/60 border-b border-zinc-200 dark:border-zinc-800">
                ...
                <table class="min-w-[1400px] w-full text-sm table-fixed">
                    <thead>ext
                        <tr class="border-b border-zinc-100 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-900/30">
                            ...
                            <th class="w-[110px] px-4 py-3 text-center text-[11px] font-semibold uppercase tracking-wider text-zinc-400">Status</th>
                            <th class="w-[120px] px-4 py-3 text-center text-[11px] font-semibold uppercase tracking-wider text-zinc-400">Suhu</th>
                            <th class="w-[120px] px-4 py-3 text-center text-[11px] font-semibold uppercase tracking-wider text-zinc-400">Kelembapan</th>
                            <th class="w-[140px] px-4 py-3 text-center text-[11px] font-semibold uppercase tracking-wider text-zinc-400">Tekanan</th>
                            <th class="w-[140px] px-4 py-3 text-center text-[11px] font-semibold uppercase tracking-wider text-zinc-400">Angin</th>
                            <th class="w-[150px] px-4 py-3 text-center text-[11px] font-semibold uppercase tracking-wider text-zinc-400">Arah Angin</th>
                            <th class="w-[130px] px-4 py-3 text-center text-[11px] font-semibold uppercase tracking-wider text-zinc-400">Ketinggian</th>
                            <th class="w-[160px] px-4 py-3 text-center text-[11px] font-semibold uppercase tracking-wider text-zinc-400">Last Update</th>
                            <th class="w-[100px] px-4 py-3 text-center text-[11px] font-semibold uppercase tracking-wider text-zinc-400">Aksi</th>
                        </tr>
                    </thead>
                    ...
                    <tbody class="divide-y divide-zinc-100 dark:divide-zinc-800/60">
                        @forelse($devices as $d)
                            ...
                            <tr class="group hover:bg-zinc-50/80 dark:hover:bg-zinc-900/40 transition-colors duration-150">
                                ...
                                <td class="px-4 py-3.5 text-center">
                                    @if ($d['online'])
                                        <span class="inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-[11px] font-semibold border border-emerald-500/20 bg-emerald-500/10 text-emerald-600 dark:text-emerald-400">
                                    ...
                                    @else
                                        <span class="inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-[11px] font-semibold border border-red-500/20 bg-red-500/10 text-red-600 dark:text-red-400">
                                ...
                                <td class="px-4 py-3.5 text-center">
                                    @if ($d['suhu'] !== null)
                                        <span class="font-semibold text-orange-500 dark:text-orange-400">{{ $d['suhu'] }}</span>
                                ...
                                <td class="px-4 py-3.5 text-center">
                                    @if ($d['kelembapan'] !== null)
                                        <span class="font-semibold text-cyan-500 dark:text-cyan-400">{{ $d['kelembapan'] }}</span>
                                ...
                                <td class="px-4 py-3.5 text-center">
                                    @if ($d['tekanan_udara'] !== null)
                                        <span class="font-semibold text-emerald-600 dark:text-emerald-400">{{ $d['tekanan_udara'] }}</span>
                                ...
                                <td class="px-4 py-3.5 text-center">
                                    @if ($d['kecepatan_angin'] !== null)
                                        <span class="font-semibold text-amber-500 dark:text-amber-400">{{ $d['kecepatan_angin'] }}</span>
                                ...
                                <td class="px-4 py-3.5 text-center">
                                    @if ($d['arah_angin'] !== null)
                                        ...
                                        <span class="text-xs text-zinc-400"> ({{ $d['arah_angin'] !== null ? $this->degreesToCompass($d['arah_angin']) : '-' }})</span>
                                    @else
                                        <span class="text-zinc-300 dark:text-zinc-600">—</span>
                                    @endif
                                </td>
                                ...
                                <td class="px-4 py-3.5 text-center">
                                    @if ($d['ketinggian_air'] !== null)
                                        <span class="font-bold text-blue-600 dark:text-blue-400">{{ $d['ketinggian_air'] }}</span>
                            ...
                            <tr>
                                <td colspan="11" class="px-5 py-16 text-center">
                                    <div class="flex flex-col items-center gap-3">
                                        ...
                                        <p class="text-xs text-zinc-400 dark:text-zinc-500">Coba ubah filter pencarian</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 px-4 py-3
                ...
                <span class="text-xs text-zinc-500 dark:text-zinc-400">
                    Menampilkan
                    <span class="font-semibold text-zinc-700 dark:text-zinc-300">{{ $devices->firstItem() ?? 0 }}–{{ $devices->lastItem() ?? 0 }}</span>
                    dari
                    <span class="font-semibold text-zinc-700 dark:text-zinc-300">{{ $devices->total() }}</span>
                    device
                </span>
        ...
        @if ($modalOpen && $this->detailDevice)
            ...
            <div class="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4">
                ...
                {{-- Modal --}}
                <div class="relative w-full sm:max-w-5xl mx-0 sm:mx-4
                    ...
                    {{-- Modal Header --}}
                    <div class="sticky top-0 z-10 flex items-center justify-between gap-3 px-5 py-4
                                border-b border-zinc-100 dark:border-zinc-800
                                bg-white/90 dark:bg-zinc-950/90 backdrop-blur-sm">
                        <div class="flex items-center gap-3 min-w-0">
                            <div class="flex h-9 w-9 items-center justify-center rounded-xl bg-blue-500/10 border border-blue-500/20 text-blue-500 shrink-0">
                    ...
                    <div class="p-5 space-y-5">
                        ...
                        <div class="grid grid-cols-3 gap-3">
                            <div class="rounded-2xl border border-zinc-100 dark:border-zinc-800 bg-zinc-50/70 dark:bg-zinc-900/40 px-4 py-3">
                                <p class="text-[10px] font-semibold uppercase tracking-wide text-zinc-400">Device ID</p>
                            ...
                            <div class="rounded-2xl border border-zinc-100 dark:border-zinc-800 bg-zinc-50/70 dark:bg-zinc-900/40 px-4 py-3">
                                ...
                                <p class="mt-1.5 text-sm font-bold {{ $isOnline ? 'text-emerald-500' : 'text-red-500' }}">
                                    {{ $isOnline ? '● Online' : '● Offline' }}
                                </p>
                            </div>
                            <div class="rounded-2xl border border-zinc-100 dark:border-zinc-800 bg-zinc-50/70 dark:bg-zinc-900/40 px-4 py-3">
                                <p class="text-[10px] font-semibold uppercase tracking-wide text-zinc-400">Last Update</p>
                        ...
                        {{-- Latest Reading Grid --}}
                        <div>
                            <p class="text-xs font-semibold text-zinc-400 uppercase tracking-wide mb-3">Pembacaan Terbaru</p>
                            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
                                @foreach ([
                                    ['label' => 'Suhu',        'value' => $detailReading?->suhu,           'unit' => '°C',  'color' => 'orange'],
                                    ['label' => 'Kelembapan',  'value' => $detailReading?->kelembapan,     'unit' => '%',   'color' => 'cyan'],
                                    ['label' => 'Tekanan',     'value' => $detailReading?->tekanan_udara,  'unit' => 'hPa', 'color' => 'emerald'],
                                    ['label' => 'Angin',       'value' => $detailReading?->kecepatan_angin,'unit' => 'm/s', 'color' => 'amber'],
                                    ['label' => 'Arah Angin',  'value' => $detailReading?->arah_angin,     'unit' => '°',   'color' => 'violet'],
                                    ['label' => 'Ketinggian',  'value' => $detailReading?->ketinggian_air, 'unit' => 'cm',  'color' => 'blue'],
                                ] as $sensor)
                                    <div class="rounded-2xl border border-{{ $sensor['color'] }}-100 dark:border-{{ $sensor['color'] }}-500/20 bg-{{ $sensor['color'] }}-50 dark:bg-{{ $sensor['color'] }}-500/10 p-3 text-center">
                                        <p class="text-[10px] font-semibold uppercase tracking-wide text-{{ $sensor['color'] }}-600 dark:text-{{ $sensor['color'] }}-400">
                                            {{ $sensor['label'] }}
                                        </p>
                                        @if ($sensor['value'] !== null)
                                            <p class="text-xl font-extrabold text-zinc-900 dark:text-white mt-1.5">{{ $sensor['value'] }}</p>
                                            <p class="text-[10px] text-zinc-400 mt-0.5">{{ $sensor['unit'] }}</p>
                                        @else
                                            <p class="text-xl font-extrabold text-zinc-300 dark:text-zinc-600 mt-1.5">—</p>
                                        @endif
                                    </div>
                                @endforeach
                            </div>
                        ...
                        <div>
                            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-3">
                                <div>
                                    <p class="text-xs font-semibold text-zinc-400 uppercase tracking-wide">Riwayat Sensor</p>
                            ...
                            <div class="rounded-2xl border border-zinc-200 dark:border-zinc-800 overflow-hidden">
                                <div class="overflow-x-auto">
                                    <table class="min-w-[900px] w-full text-sm">
                                        <thead>
                                            <tr class="border-b border-zinc-100 dark:border-zinc-800 bg-zinc-50/80 dark:bg-zinc-900/50">
                                            ...
                                            @forelse ($detailHistory as $row)
                                                <tr class="hover:bg-zinc-50/80 dark:hover:bg-zinc-900/40 transition-colors">
                                                    ...
                                                    <td class="px-4 py-3 text-center text-xs">
                                                        ...
                                                        @else <span class="text-zinc-300 dark:text-zinc-600">—</span> @endif
                                                    </td>
                                                    <td class="px-4 py-3 text-center text-xs">
                                                    ...
                                                    <td class="px-4 py-3 text-center text-xs">
                                                        @if ($row['arah_angin'] !== null)
                                                            <span class="font-semibold text-violet-500">{{ $row['arah_angin'] }}°</span>
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="7" class="px-4 py-10 text-center">
                                                        <p class="text-sm text-zinc-400">Tidak ada data pada range ini</p>
                                                    </td>
                                                </tr>
                                            @endforelse
                                        </tbody>
                                ...
                                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 px-4 py-3
                                    ...
                                    <span class="text-xs text-zinc-400">
                                        Menampilkan
                                        <span class="font-semibold text-zinc-600 dark:text-zinc-300">{{ $detailHistory->firstItem() ?? 0 }}–{{ $detailHistory->lastItem() ?? 0 }}</span>
                                        dari
                                        <span class="font-semibold text-zinc-600 dark:text-zinc-300">{{ $detailHistory->total() }}</span>
                                        data
                                    </span>
                                    <div class="overflow-x-auto">
                    ...
                    {{-- Modal Footer --}}
                    <div class="sticky bottom-0 flex items-center justify-end gap-2 px-5 py-4
                                border-t border-zinc-100 dark:border-zinc-800
                                bg-white/90 dark:bg-zinc-950/90 backdrop-blur-sm">
                        <button wire:click="closeModal"
