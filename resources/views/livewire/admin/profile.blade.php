                ...
                <div class="overflow-hidden rounded-3xl bg-white shadow-md ring-1 ring-slate-200 transition-colors duration-300 dark:bg-slate-900 dark:ring-slate-800">
                    ...
                    <div class="relative h-36 overflow-hidden bg-gradient-to-br from-blue-600 via-indigo-500 to-cyan-400">
                        ...
                        <div class="absolute left-5 top-5">
                            <span class="inline-flex items-center rounded-full bg-white/20 px-3 py-1 text-xs font-semibold text-white backdrop-blur-sm">
                                My Profile
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="relative px-6 pb-6">
                        ...
                        <div class="-mt-14 mb-4 flex justify-center">
                            ...
                            @elseif ($storedFotoProfil)
                                ...
                                >
                            @else
                                <div class="flex h-28 w-28 items-center justify-center rounded-full border-4 border-white bg-slate-100 text-3xl font-bold text-slate-500 shadow-xl dark:border-slate-900 dark:bg-slate-800 dark:text-slate-300">
                        ...
                        <div class="mt-6 grid grid-cols-2 gap-3">
                            <div class="rounded-2xl bg-slate-50 p-4 text-center transition-colors duration-300 dark:bg-slate-800">
                        ...
                        <!-- QR Section -->
                        <div class="mt-4 rounded-3xl bg-gradient-to-br from-slate-50 to-slate-100 p-5 text-center ring-1 ring-slate-200 transition-colors duration-300 dark:from-slate-800 dark:to-slate-800/80 dark:ring-slate-700">
                            ...
                            <div class="flex justify-center">
                                <div class="rounded-2xl bg-white p-4 shadow-sm ring-1 ring-slate-200 dark:bg-slate-900 dark:ring-slate-700 [&>svg]:h-44 [&>svg]:w-44">
                                    {!! $qrCode !!}
                                </div>
                            </div>
