<div class="min-h-screen bg-slate-50 p-4 transition-colors duration-300 dark:bg-slate-950 sm:p-6 lg:p-8 xl:p-10">
    <div class="mx-auto max-w-7xl">
        ...
        {{-- Layout: 1 col mobile, 3 col desktop (2+1) --}}
        <div class="grid grid-cols-1 gap-6 xl:grid-cols-3">

            {{-- THRESHOLD SENSOR (Admin only) — 2/3 lebar --}}
            @if ($isAdmin)
                <div class="xl:col-span-2">
                    <div class="overflow-hidden rounded-3xl bg-white shadow-sm ring-1 ring-slate-200 transition-colors duration-300 dark:bg-slate-900 dark:ring-slate-800">
                        ...
                        <form wire:submit.prevent="saveThreshold" class="p-5 sm:p-6">
                            ...
                            {{-- Sensor grid: 1 col mobile → 2 col tablet → 3 col desktop --}}
                            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-3">
                                @foreach ($sensors as $key => $sensor)
                                    <div class="rounded-2xl border border-slate-100 bg-slate-50/60 p-4 dark:border-slate-800 dark:bg-slate-800/40">
                                        ...
                                        <div class="space-y-2.5">
                                            <div>
                                                <label class="mb-1 block text-xs font-medium text-amber-600 dark:text-amber-400">Batas Waspada</label>
                                            ...
                                            <div>
                                                <label class="mb-1 block text-xs font-medium text-rose-600 dark:text-rose-400">Batas Bahaya</label>
                                                <input type="number" step="0.01"
                            ...
                            {{-- Legend --}}
                            <div class="mt-5 flex flex-wrap items-center gap-4 rounded-2xl border border-dashed border-slate-200 px-4 py-3 dark:border-slate-700">
            ...
            {{-- NOTIFIKASI TELEGRAM — 1/3 lebar (atau full kalau bukan admin) --}}
            <div class="{{ $isAdmin ? 'xl:col-span-1' : 'xl:col-span-3 max-w-2xl mx-auto w-full' }}">
                <div class="overflow-hidden rounded-3xl bg-white shadow-sm ring-1 ring-slate-200 transition-colors duration-300 dark:bg-slate-900 dark:ring-slate-800 h-full">
                    ...
                    <div class="relative border-b border-slate-100 px-5 py-4 dark:border-slate-800 sm:px-6 sm:py-5">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-slate-500 dark:text-slate-400">Peringatan otomatis saat status berubah</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <form wire:submit.prevent="saveNotifikasi" class="p-5 sm:p-6">
                        <div class="space-y-5">
                            ...
                            <div class="rounded-2xl border border-dashed border-blue-200 bg-blue-50/50 px-4 py-4 dark:border-blue-500/20 dark:bg-blue-500/5">
                                ...
                                <p class="mt-0.5 text-xs text-slate-500 dark:text-slate-400">Kirim pesan test ke Chat ID yang sudah diisi</p>
