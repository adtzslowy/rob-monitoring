            ...
            <div
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full w-full text-sm border-collapse table-fixed">
                        ...
                        <thead
                            class="text-xs uppercase bg-zinc-50 dark:bg-zinc-900/50 text-zinc-600 dark:text-zinc-400">
                            <tr>
            ...
            @if ($modalOpen)
                <div class="fixed inset-0 z-50 flex items-center justify-center">
                            ...
                            @if ($role === 'operator')
                                <div class="mt-3" x-data="{
                                    ...
                                    <div class="mt-2 flex flex-wrap gap-2">
                                        <template x-for="val in ($wire.operator_device_ids || [])"
                                            :key="val">
                                            <span
                 ...
                 text-zinc-900 dark:text-zinc-100 flex items-center justify-between">
                                        ...
                                        {{-- dropdown --}}
                                        <div x-show="isOpen" @click.outside="close()" x-transition
                 ...
                 bg-white dark:bg-zinc-950 shadow-lg overflow-hidden">
                         ...
                         text-zinc-900 dark:text-zinc-100 focus:outline-none" />
                                            ...
                                            <div class="max-h-56 overflow-auto" x-ref="list">
                                                <template x-for="(opt, idx) in filteredOptions()"
                                                    :key="opt.value">
