<section class="py-16 sm:py-20 lg:py-24 bg-slate-50 dark:bg-slate-950">
    <div class="mx-auto max-w-7xl px-3 sm:px-4 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div class="space-y-6">
                <div
                    class="flex items-start gap-4 p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm">
                    <div
                        class="flex-shrink-0 w-12 h-12 rounded-xl bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-slate-600 dark:text-slate-400">
                            Jl. Urip Sumoharjo, Kantor, Kec. Delta Pawan, </br> Kabupaten Ketapang, Kalimantan Barat
                            78821
                        </p>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-slate-900 dark:text-white">Telegram</h3>
                        <p class="mt-1 text-slate-600 dark:text-slate-400">
                            @rob_monitoring_bot
                        </p>
                    </div>
                ...
                <form wire:submit.prevent="submit" class="space-y-5">
                   ...
                   focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    <div>
                        ...
                        <input type="email" wire:model.defer="email" placeholder="email@anda.com"
                            class="w-full px-4 py-3 rounded-xl border border-slate-200 dark:border-slate-700 
                   bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-white 
                   focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    <div>
                        ...
                        <textarea rows="4" wire:model.defer="message" placeholder="Tulis pesan Anda..."
                            class="w-full px-4 py-3 rounded-xl border border-slate-200 dark:border-slate-700 
                   bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-white 
                   focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none"></textarea>
                    ...
                    <button type="submit" wire:loading.attr="disabled"
                        class="w-full py-3 px-6 rounded-xl bg-blue-600 hover:bg-blue-700 
