    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            @foreach ([
                ...
                ['bg' => 'blue',  'title' => 'Notifikasi Telegram', 'desc' => 'Peringatan otomatis dikirim ke Telegram saat status berubah ke WASPADA, SIAGA, atau BAHAYA — meski tidak sedang membuka aplikasi.',
