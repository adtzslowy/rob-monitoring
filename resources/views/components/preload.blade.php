...
<div id="rob-preloader"
    ...
    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2
                w-80 h-80 rounded-full bg-blue-600/10 dark:bg-blue-600/20 blur-3xl pointer-events-none"></div>

    {{-- spinner --}}
    <div class="relative w-14 h-14 z-10">
        <div class="absolute inset-0 rounded-full border-[2.5px] border-transparent
                    border-t-blue-500 border-r-blue-500/20 border-b-blue-500/10
                    animate-spin"></div>
        ...
        <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2
                    w-2 h-2 rounded-full bg-blue-500 dark:bg-blue-400 animate-pulse"></div>
    </div>

    {{-- teks --}}
    <div class="text-center z-10">
        <p class="text-sm font-bold tracking-wide text-slate-900 dark:text-white">
            ROB Monitoring
        </p>
        <p class="text-xs text-slate-400 mt-1 flex items-center justify-center gap-1">
            ...
            <span class="flex gap-0.5 ml-0.5">
                <span class="w-1 h-1 rounded-full bg-blue-500 dark:bg-blue-400
                             animate-[bounce_1.2s_ease-in-out_infinite]"></span>
                <span class="w-1 h-1 rounded-full bg-blue-500 dark:bg-blue-400
                             animate-[bounce_1.2s_ease-in-out_0.2s_infinite]"></span>
                <span class="w-1 h-1 rounded-full bg-blue-500 dark:bg-blue-400
                             animate-[bounce_1.2s_ease-in-out_0.4s_infinite]"></span>
            </span>
        </p>
    </div>

    {{-- progress bar --}}
    <div class="w-32 h-0.5 rounded-full bg-blue-500/15 overflow-hidden z-10">
        <div id="rob-pl-bar"
